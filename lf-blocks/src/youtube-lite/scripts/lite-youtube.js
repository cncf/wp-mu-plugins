 ...
 * Lite YouTube script.
 *
 * Forked from https://github.com/justinribeiro/lite-youtube
 *
 * @package WordPress
 * @since 1.35
 *
...
class LiteYTEmbed extends HTMLElement {
   ...
   */
	__setupDom() {
      ...
      <div id="frame" width="100%" height="200px">
        <picture>
...
<iframe frameborder="0"
  ...
  src="https://www.youtube-nocookie.com/embed/${ this.videoId }?autoplay=1&start=${ this.videoStartAt }"
></iframe>`;
